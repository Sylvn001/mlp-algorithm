            ...
            for (let j = 0; j < this.headerClass.length; j++) {
              ...
              for (let k = 0; k < this.camadaO; k++) {
                ...
                for (let l = 0; l < this.camadaE; l++) {
                  net[k] += this.retornaValorNomalizado(this.csvTraining[i][j], j) * parseFloat(pesoEtoO[l][k]);
                }
              ...
              for (let l = 0; l < this.camadaS; l++) {
                for (let k = 0; k < this.camadaO; k++) {
                  let novoPeso = parseFloat(pesoOtoS[k][l]) + parseFloat(this.txAprendizado * ErroS[l] * IC[k]);
              ...
              for (let l = 0; l < this.camadaO; l++) {
                for (let k = 0; k < this.camadaE; k++) {
                  let novoPeso = parseFloat(pesoEtoO[k][l]) + parseFloat(this.txAprendizado * Erro[l] * this.retornaValorNomalizado(this.csvTraining[i][j], j));
